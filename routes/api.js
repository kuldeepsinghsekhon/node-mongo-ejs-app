...
router.get('/user/settings/profile',passport.authenticate('local', { session : false }), settings_controller.profileInfo);
router.post('/user/settings/update-profile',passport.authenticate('local', { session : false }), settings_controller.saveProfile);
router.post('/user/settings/seller-info',passport.authenticate('local', { session : false }), settings_controller.saveSellerInfo);
router.post('/user/settings/shipping-info',passport.authenticate('local', { session : false }), settings_controller.saveShippingInfo);
router.post('/user/settings/buyer-info',passport.authenticate('local', { session : false }), settings_controller.saveBuyerInfo);
router.post('/user/settings/address-info',passport.authenticate('local', { session : false }), settings_controller.addressInfo);
